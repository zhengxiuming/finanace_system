...
const columns = tableData.tableColumns.staySettleDetail;
const data = [{
  key: '1',
...
//修饰器
@TimeFilter
class staySettleDetail extends React.Component {
  constructor(props) {
    super(props);
      ...
      <div>
        <Card hoverable={true}>
          ...
          <div className={styles.table}>
            <Table columns={columns} pagination={{showTotal:(total,range)=>`共${total}条数据`,size:'small',total: 150, showSizeChanger: true, showQuickJumper: true}}
...
staySettleDetail = Form.create()(staySettleDetail);
export default connect(({recordedDetail, loading}) => ({recordedDetail, loading}))(staySettleDetail);
